...
C     
C     Process: d d~ > z > u u~ WEIGHTED<=4 @1
C     Process: s s~ > z > u u~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3_3(W(1,1),W(1,4),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,9)) ! count 2
      CALL FFV2_3_3(W(1,2),W(1,3),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,10)) ! count 2
