...
C     
C     Process: u u~ > z > u u~ WEIGHTED<=4 @1
C     Process: c c~ > z > u u~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_5_3(W(1,1),W(1,4),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,9)) ! count 2
      CALL FFV2_5_3(W(1,2),W(1,3),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,10)) ! count 2
      CALL FFV2_5_0(W(1,7),W(1,6),W(1,9),-GC_50,GC_58,AMP(1,1))
      CALL FFV2_5_0(W(1,7),W(1,6),W(1,10),-GC_50,GC_58,AMP(3,1))
      CALL FFV2_5_0(W(1,8),W(1,5),W(1,9),-GC_50,GC_58,AMP(2,1))
      CALL FFV2_5_0(W(1,8),W(1,5),W(1,10),-GC_50,GC_58,AMP(4,1)) ! count 1
