...
C     Amplitude(s) for diagram number 2
      ...
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,4),W(1,5),GC_10,AMP(5))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,2),W(1,3),W(1,5),GC_10,AMP(6))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(3) = AMP(3) +  AMP(6)  ! used 4 times
      TMP_JAMP(2) = AMP(1) +  AMP(4)  ! used 4 times
      TMP_JAMP(1) = AMP(2) +  AMP(5)  ! used 4 times
