...
C     Process: g g > c c~ WEIGHTED<=2 @1
C     Process: g g > d d~ WEIGHTED<=2 @1
C     Process: g g > s s~ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 4
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 4
      CALL OXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5)) ! count 4
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6)) ! count 4
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,7)) ! count 4
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,8)) ! count 4
      CALL FFV1_1(W(1,5),W(1,1),GC_11,ZERO, FK_ZERO,W(1,11)) ! count 1
      CALL FFV1_1(W(1,5),W(1,2),GC_11,ZERO, FK_ZERO,W(1,12)) ! count 1
      CALL FFV1_1(W(1,6),W(1,1),GC_11,ZERO, FK_ZERO,W(1,13)) ! count 1
      CALL FFV1_1(W(1,6),W(1,2),GC_11,ZERO, FK_ZERO,W(1,14)) ! count 1
      CALL FFV1_0(W(1,7),W(1,13),W(1,4),GC_11,AMP(3,2))
      CALL FFV1_0(W(1,7),W(1,14),W(1,3),GC_11,AMP(1,2))
      CALL FFV1_0(W(1,8),W(1,11),W(1,4),GC_11,AMP(4,2))
      CALL FFV1_0(W(1,8),W(1,12),W(1,3),GC_11,AMP(2,2)) ! count 1
      CALL FFV1_2(W(1,7),W(1,1),GC_11,ZERO, FK_ZERO,W(1,15)) ! count 1
      CALL FFV1_2(W(1,7),W(1,2),GC_11,ZERO, FK_ZERO,W(1,16)) ! count 1
      CALL FFV1_2(W(1,8),W(1,1),GC_11,ZERO, FK_ZERO,W(1,17)) ! count 1
      CALL FFV1_2(W(1,8),W(1,2),GC_11,ZERO, FK_ZERO,W(1,18)) ! count 1
      CALL FFV1_0(W(1,15),W(1,6),W(1,4),GC_11,AMP(3,3))
      CALL FFV1_0(W(1,16),W(1,6),W(1,3),GC_11,AMP(1,3))
      CALL FFV1_0(W(1,17),W(1,5),W(1,4),GC_11,AMP(4,3))
      CALL FFV1_0(W(1,18),W(1,5),W(1,3),GC_11,AMP(2,3)) ! count 1
