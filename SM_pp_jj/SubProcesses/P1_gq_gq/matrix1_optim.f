...
C     
C     Process: g u > g u WEIGHTED<=2 @1
C     Process: g c > g c WEIGHTED<=2 @1
C     Process: g d > g d WEIGHTED<=2 @1
C     Process: g s > g s WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7)) ! count 5
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8)) ! count 5
      CALL VVV1P0_1(W(1,1),W(1,5),GC_10,ZERO, FK_ZERO,W(1,9)) ! count 2
      CALL VVV1P0_1(W(1,2),W(1,6),GC_10,ZERO, FK_ZERO,W(1,10)) ! count 2
      CALL FFV1_0(W(1,3),W(1,7),W(1,9),GC_11,AMP(3,1))
      CALL FFV1_0(W(1,3),W(1,7),W(1,10),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,4),W(1,8),W(1,9),GC_11,AMP(4,1))
      CALL FFV1_0(W(1,4),W(1,8),W(1,10),GC_11,AMP(2,1)) ! count 1
      CALL FFV1_1(W(1,7),W(1,1),GC_11,ZERO, FK_ZERO,W(1,11)) ! count 1
      CALL FFV1_1(W(1,7),W(1,2),GC_11,ZERO, FK_ZERO,W(1,12)) ! count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO, FK_ZERO,W(1,13)) ! count 1
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO, FK_ZERO,W(1,14)) ! count 1
      CALL FFV1_0(W(1,3),W(1,11),W(1,5),GC_11,AMP(3,2))
      CALL FFV1_0(W(1,3),W(1,12),W(1,6),GC_11,AMP(1,2))
      CALL FFV1_0(W(1,4),W(1,13),W(1,5),GC_11,AMP(4,2))
      CALL FFV1_0(W(1,4),W(1,14),W(1,6),GC_11,AMP(2,2)) ! count 1
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,15)) ! count 1
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,18)) ! count 1
      CALL FFV1_0(W(1,15),W(1,7),W(1,5),GC_11,AMP(3,3))
      CALL FFV1_0(W(1,18),W(1,8),W(1,6),GC_11,AMP(2,3)) ! count 1
