...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL VXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5)) ! count 5
      CALL VXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6)) ! count 5
      CALL VXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7)) ! count 5
      CALL VXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8)) ! count 5
      CALL VVV1P0_1(W(1,5),W(1,8),GC_10,ZERO, FK_ZERO,W(1,9)) ! count 2
      CALL VVV1P0_1(W(1,6),W(1,7),GC_10,ZERO, FK_ZERO,W(1,10)) ! count 2
      CALL FFV1_0(W(1,1),W(1,4),W(1,9),GC_11,AMP(2,1))
      CALL FFV1_0(W(1,1),W(1,4),W(1,10),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,2),W(1,3),W(1,9),GC_11,AMP(4,1))
      CALL FFV1_0(W(1,2),W(1,3),W(1,10),GC_11,AMP(3,1)) ! count 1
      CALL FFV1_1(W(1,3),W(1,5),GC_11,ZERO, FK_ZERO,W(1,11)) ! count 1
      CALL FFV1_1(W(1,3),W(1,6),GC_11,ZERO, FK_ZERO,W(1,12)) ! count 1
      CALL FFV1_1(W(1,4),W(1,5),GC_11,ZERO, FK_ZERO,W(1,13)) ! count 1
      CALL FFV1_1(W(1,4),W(1,6),GC_11,ZERO, FK_ZERO,W(1,14)) ! count 1
      CALL FFV1_0(W(1,1),W(1,13),W(1,8),GC_11,AMP(2,2))
      CALL FFV1_0(W(1,1),W(1,14),W(1,7),GC_11,AMP(1,2))
      CALL FFV1_0(W(1,2),W(1,11),W(1,8),GC_11,AMP(4,2))
      CALL FFV1_0(W(1,2),W(1,12),W(1,7),GC_11,AMP(3,2)) ! count 1
      CALL FFV1_2(W(1,1),W(1,5),GC_11,ZERO, FK_ZERO,W(1,15)) ! count 1
      CALL FFV1_2(W(1,1),W(1,6),GC_11,ZERO, FK_ZERO,W(1,16)) ! count 1
      CALL FFV1_2(W(1,2),W(1,5),GC_11,ZERO, FK_ZERO,W(1,17)) ! count 1
      CALL FFV1_2(W(1,2),W(1,6),GC_11,ZERO, FK_ZERO,W(1,18)) ! count 1
      CALL FFV1_0(W(1,15),W(1,4),W(1,8),GC_11,AMP(2,3))
      CALL FFV1_0(W(1,16),W(1,4),W(1,7),GC_11,AMP(1,3))
      CALL FFV1_0(W(1,17),W(1,3),W(1,8),GC_11,AMP(4,3))
      CALL FFV1_0(W(1,18),W(1,3),W(1,7),GC_11,AMP(3,3)) ! count 1
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = ((0.000000000000000D+00,-1.000000000000000D+00)) *AM
     $  P( K,1)+AMP( K,2)
