...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6)) ! count 1
      ...
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO, FK_ZERO,W(1,10)) ! count 2
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_11,AMP(2,1))
      CALL FFV1_0(W(1,7),W(1,3),W(1,10),GC_11,AMP(4,1))
      CALL FFV1_0(W(1,8),W(1,4),W(1,9),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,8),W(1,4),W(1,10),GC_11,AMP(3,1)) ! count 1
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = (5.000000000000000D-01)*AMP( K,1)
        JAMP(2,1) = (-1.666666666666667D-01)*AMP( K,1)
