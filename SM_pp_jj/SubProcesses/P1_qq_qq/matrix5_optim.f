...
C     
C     Process: u u~ > c c~ WEIGHTED<=2 @1
C     Process: u u~ > d d~ WEIGHTED<=2 @1
C     Process: u u~ > s s~ WEIGHTED<=2 @1
C     Process: c c~ > u u~ WEIGHTED<=2 @1
C     Process: c c~ > d d~ WEIGHTED<=2 @1
C     Process: c c~ > s s~ WEIGHTED<=2 @1
C     Process: d d~ > u u~ WEIGHTED<=2 @1
C     Process: d d~ > c c~ WEIGHTED<=2 @1
C     Process: d d~ > s s~ WEIGHTED<=2 @1
C     Process: s s~ > u u~ WEIGHTED<=2 @1
C     Process: s s~ > c c~ WEIGHTED<=2 @1
C     Process: s s~ > d d~ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5)) ! count 2
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6)) ! count 2
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,7)) ! count 2
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,8)) ! count 2
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,9)) ! count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10)) ! count 2
      CALL FFV1_0(W(1,7),W(1,6),W(1,9),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,7),W(1,6),W(1,10),GC_11,AMP(3,1))
      CALL FFV1_0(W(1,8),W(1,5),W(1,9),GC_11,AMP(2,1))
      CALL FFV1_0(W(1,8),W(1,5),W(1,10),GC_11,AMP(4,1)) ! count 1
