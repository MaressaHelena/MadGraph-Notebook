...
C     
C     Process: u u > u u WEIGHTED<=2 @1
C     Process: c c > c c WEIGHTED<=2 @1
C     Process: d d > d d WEIGHTED<=2 @1
C     Process: s s > s s WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5)) ! count 3
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6)) ! count 3
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7)) ! count 3
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8)) ! count 3
      CALL FFV1P0_3(W(1,1),W(1,5),GC_11,ZERO, FK_ZERO,W(1,9)) ! count 2
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO, FK_ZERO,W(1,12)) ! count 2
      CALL FFV1_0(W(1,3),W(1,7),W(1,9),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,3),W(1,7),W(1,12),GC_11,AMP(4,1))
      CALL FFV1_0(W(1,4),W(1,8),W(1,9),GC_11,AMP(3,1))
      CALL FFV1_0(W(1,4),W(1,8),W(1,12),GC_11,AMP(6,1)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,13)) ! count 2
      CALL FFV1P0_3(W(1,2),W(1,8),GC_11,ZERO, FK_ZERO,W(1,16)) ! count 2
      CALL FFV1_0(W(1,3),W(1,5),W(1,13),GC_11,AMP(1,2))
      CALL FFV1_0(W(1,3),W(1,5),W(1,16),GC_11,AMP(5,2))
      CALL FFV1_0(W(1,4),W(1,6),W(1,13),GC_11,AMP(2,2))
      CALL FFV1_0(W(1,4),W(1,6),W(1,16),GC_11,AMP(6,2)) ! count 1
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = (1.666666666666667D-01)*AMP( K,1)+(5.000000000000000
     $  D -01)*AMP( K,2)
        JAMP(2,1) = (-5.000000000000000D-01)*AMP( K,1)+(-1.6666666666666
     $  67D -01)*AMP( K,2)
