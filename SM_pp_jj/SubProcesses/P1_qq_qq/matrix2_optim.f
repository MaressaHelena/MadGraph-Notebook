...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFV1_0(W(1,7),W(1,6),W(1,10),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,7),W(1,6),W(1,11),GC_11,AMP(5,1))
      CALL FFV1_0(W(1,8),W(1,5),W(1,10),GC_11,AMP(2,1))
      CALL FFV1_0(W(1,8),W(1,5),W(1,11),GC_11,AMP(6,1)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,5),GC_11,ZERO, FK_ZERO,W(1,13)) ! count 2
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO, FK_ZERO,W(1,16)) ! count 2
      CALL FFV1_0(W(1,7),W(1,3),W(1,13),GC_11,AMP(3,2))
      CALL FFV1_0(W(1,7),W(1,3),W(1,16),GC_11,AMP(5,2))
      CALL FFV1_0(W(1,8),W(1,4),W(1,13),GC_11,AMP(2,2))
      CALL FFV1_0(W(1,8),W(1,4),W(1,16),GC_11,AMP(4,2)) ! count 1
